...
import { computeStats, scoreMetric, SUITE_CONFIG } from '../dns.js';
import type { DnsWorkloadResult } from '../dns.js';

describe('scoring: dns', () => {
  ...
  test('computeStats handles all-failure iterations', () => {
    const results: DnsWorkloadResult[] = [
      { ok: false, suite: 'dns', reason: 'error', error: 'test', meta: {} },
      { ok: false, suite: 'dns', reason: 'timeout', error: 'test', meta: {} },
    ];
  ...
  test('computeStats produces median and score for successful runs', () => {
    ...
    const results: DnsWorkloadResult[] = [
      { ok: true, suite: 'dns', metric: { value: val, unit: suite.unit, higherIsBetter: suite.higherIsBetter }, meta: {} },
      { ok: true, suite: 'dns', metric: { value: val, unit: suite.unit, higherIsBetter: suite.higherIsBetter }, meta: {} },
      { ok: true, suite: 'dns', metric: { value: val, unit: suite.unit, higherIsBetter: suite.higherIsBetter }, meta: {} },
    ];
