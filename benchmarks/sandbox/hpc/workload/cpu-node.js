 ...
 * /tmp/hpc/fixture. Runs `node src/index.js` of the fixture once, reads
...
const FIXTURE_ROOT = process.env.HPC_FIXTURE_ROOT || '/tmp/hpc/fixture';
...
if (result.error) {
  emitWorkloadResult({
    ...
    meta: { fixtureVersion: process.env.HPC_FIXTURE_VERSION, workloadMs: wallMs },
  });
  process.exit(0);
}
...
emitWorkloadResult({
  ...
  meta: {
    fixtureVersion: process.env.HPC_FIXTURE_VERSION,
    workloadMs: wallMs,
