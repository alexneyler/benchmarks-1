...
- **Kimi family** (`ai-gateway-kimi.bench.ts` + `providers-kimi.ts`) — nine gateways (OpenRouter, Vercel AI Gateway, Cloudflare AI Gateway, LLM Gateway, Concentrate AI, Novita, Ramp Router, Neon AI Gateway, and ngrok AI Gateway; Pydantic excluded — see below) routed to `kimi-k3`, measured against a direct-to-Moonshot baseline. See [Kimi family benchmark](#kimi-family-benchmark).
...
# Kimi family — nine gateways (no Pydantic — see Kimi family benchmark above)
